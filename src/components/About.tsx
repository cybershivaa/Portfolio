      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.18fr_0.82fr] gap-8 lg:gap-10 items-start">
          ...
          <div
            ...
            style={{ "--anim-duration": "750ms", "--anim-delay": "100ms" } as React.CSSProperties}
          >
          ...
          {/* Info box */}
          <div
            className="w-full max-w-4xl mx-auto -mt-6 md:-mt-0 rounded-[20px] border border-white/10 bg-white/5/5 p-4 sm:p-5"
            data-scroll-animate="fade-left"
            style={{ "--anim-duration": "750ms", "--anim-delay": "200ms" } as React.CSSProperties}
          >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div
                    data-anim
                    style={{ "--anim-delay": "300ms" } as React.CSSProperties}
                    className="p-3 rounded-lg bg-gradient-to-br from-[#0d1730] to-[#050816] border border-blue-500/20"
                  >
                  ...
                  <div
                    ...
                    className="p-3 rounded-lg bg-gradient-to-br from-[#1a1028] to-[#050816] border border-pink-500/20"
                  >
